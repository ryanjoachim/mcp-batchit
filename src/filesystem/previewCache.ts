...
import { PreviewOptions } from "../types/filesystem/fileInfo.js"
...
interface CacheEntry {
  ...
  /**
   * Timestamp when the preview was created
   */
  timestamp: number

  /**
   * Options used to generate the preview
   */
...
class PreviewCache {
   ...
   * @returns The cached preview buffer or undefined if not found
   */
   ...
   * @param filePath Path to the file
   * @param options Preview generation options
   * @param buffer The preview image buffer
   */
